...
class WordVecLstmSigmoid(object):
    ...
    def fit(self, text_data_model, text_label_pairs, model_dir_path, batch_size=None, epochs=None,
        ...
        np.save(model_dir_path + '/' + WordVecLstmSigmoid.model_name +
    ...
    def predict(self, sentence):
        ...
        wid = [self.word2idx[token]
               if token in self.word2idx else 1 for token in tokens]
        xs.append(wid)
...
class WordVecLstmSoftmax(object):
    ...
    def fit(self, text_data_model, text_label_pairs, model_dir_path, batch_size=None, epochs=None,
        ...
        np.save(model_dir_path + '/' + WordVecLstmSoftmax.model_name +
                '-history.npy', history.history)
...
class WordVecBidirectionalLstmSoftmax(object):
    ...
    def fit(self, text_data_model, text_label_pairs, model_dir_path, batch_size=None, epochs=None,
        ...
        np.save(model_dir_path + '/' + WordVecBidirectionalLstmSoftmax.model_name +
                '-history.npy', history.history)
...
def main():
    ...
    app.test_run('i liked the Ramayana a lot.')
