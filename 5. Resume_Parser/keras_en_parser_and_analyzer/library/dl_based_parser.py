...
line_labels = {0: 'experience', 1: 'knowledge', 2: 'education', 3: 'project',
               4: 'others', 5: 'name', 6: 'email', 7: 'gender', 8: 'mobile',
               9: 'objective', 10: 'sex', 11: 'ethnicity'}
...
class ResumeParser(object):
    ...
    def fit_line_label(self, training_data_dir_path, model_dir_path, batch_size=None, epochs=None,
                       test_size=None,
                       random_state=None):
        text_data_model = fit_text(
            training_data_dir_path, label_type='line_label')
        text_label_pairs = load_text_label_pairs(
            training_data_dir_path, label_type='line_label')
    ...
    def fit_line_type(self, training_data_dir_path, model_dir_path, batch_size=None, epochs=None,
                      ...
                      random_state=None):
        text_data_model = fit_text(
            training_data_dir_path, label_type='line_type')
        text_label_pairs = load_text_label_pairs(
            training_data_dir_path, label_type='line_type')
