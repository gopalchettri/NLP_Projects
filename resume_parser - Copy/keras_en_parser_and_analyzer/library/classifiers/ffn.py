...
class WordVecGloveFFN(object):
    ...
    def create_model(self):
        ...
        self.model.add(Dense(units=64, activation='relu',
                       input_dim=self.glove_model.embedding_dim))
        self.model.add(Dropout(0.2))
        self.model.add(Dense(units=2, activation='softmax'))

        self.model.compilem (loss='categorical_crossentropy',
    ...
    def fit(self, text_data_model, text_label_pairs, model_dir_path, batch_size=None, epochs=None,
        ...
        ys = []
        X = np.zeros(shape=(len(text_label_pairs),
                     self.glove_model.embedding_dim))
        ...
        np.save(model_dir_path + '/' + WordVecGloveFFN.model_name +
